...
class AIServices:
    def __init__(self):
        ...
        # Initialize Google Gemini (Primary AI)
        if self.gemini_api_key:
            try:
                import google.generativeai as genai
                genai.configure(api_key=self.gemini_api_key)
                self.gemini_model = genai.GenerativeModel('gemini-1.5-flash')
                print("✓ Google Gemini initialized (Primary AI)")
    ...
    def ask_gemini(self, question: str, context: str = "") -> Dict[str, Any]:
        """
        ...
        if not self.gemini_model:
            return {
                'success': False,
                'message': 'Gemini is not available. Please set up your Gemini API key in the .env file.',
                'data': None
            }
        ...
        try:
            ...
            return {
                ...
                'data': {
                    ...
                    'response_metadata': 'Generated by Google Gemini'
                }
            }
